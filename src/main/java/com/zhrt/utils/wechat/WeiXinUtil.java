...
//
//	public final static String access_token_url="https://api.wechat.qq.com/cgi-bin/token?grant_type=client_credential&appid=APPID&secret=APPSECRET";
//	public final static String oauth2_1_url = "https://api.wechat.qq.com/sns/oauth2/access_token?appid=APPID&secret=SECRET&code=CODE&grant_type=authorization_code";
//	public final static String oauth2_2_url = "https://api.wechat.qq.com/sns/userinfo?access_token=ACCESS_TOKEN&openid=OPENID&lang=zh_CN";
//	public final static String get_userInfo_url="https://open.wechat.qq.com/connect/oauth2/authorize?appid=APPID&redirect_uri=REDIRECT_URI&response_type=code&scope=SCOPE&state=STATE#wechat_redirect";
//	public final static String get_hangye_url = "https://api.wechat.qq.com/cgi-bin/template/api_set_industry?access_token=ACCESS_TOKEN";
//	//上面那五个，不用改。把下边的appid和appsecret改了就行
//	public final static String appid="wx5d905856e107260a";
//	public final static String appSecret="051f78dea23ad012f11be26da1f96ccf";
//
//
//
...
//        String requestUrl = "https://api.wechat.qq.com/cgi-bin/shorturl?access_token=ACCESS_TOKEN";
//        try {
